...
public class EnxCordovaPlugin extends CordovaPlugin implements EnxRoomObserver, EnxStreamObserver, EnxScreenShotObserver, EnxActiveTalkerViewObserver, EnxActiveTalkerListObserver {
              ...
              cordova.getActivity().runOnUiThread(new Runnable() {
                  ...
                  public void run() {
                      if (mLocalStream.mEnxPlayerView != null && mLocalStream.mEnxPlayerView.getParent() == null) {
                          ...
                          EnxPlayerView enxPlayerView = new EnxPlayerView(cordova.getActivity(), EnxPlayerView.ScalingType.SCALE_ASPECT_FILL, true);
  ...
  /**
   * This method is used to initialize the remote view in which active talker will add.
   * @param args
   */
  ...
  public void onRoomConnected(EnxRoom enxRoom, JSONObject jsonObject) {
      ...
      triggerSuccussJSEvent("joinRoom", "onRoomConnected", jsonObject);
  }
  ...
  public void onRoomDisConnected(JSONObject jsonObject) {
      triggerSuccussJSEvent("disconnect", "onRoomDisConnected", jsonObject);
      releaseAllResources();
  }
  ...
  public void onNotifyDeviceUpdate(String s) {
      triggerSuccussJSEvent("switchMediaDevice","switchMediaDevice",s);
  }
  ...
  public void onAudioEvent(JSONObject jsonObject) {
      triggerSuccussJSEvent("muteSelfAudio","muteSelfAudio",jsonObject);
  }

  @Override
  public void onVideoEvent(JSONObject jsonObject) {
      triggerSuccussJSEvent("muteSelfVideo","muteSelfVideo",jsonObject);
  }
